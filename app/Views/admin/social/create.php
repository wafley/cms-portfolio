...
<form action="<?= base_url('admin/socials/store') ?>" method="POST">
    <div class="row">
        <div class="col-12">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="platform" id="platform" class="form-control" placeholder="Masukkan nama platform" value="<?= old('platform') ?>">
                    </div>

                    <div class="mb-3">
                        <label for="url" class="form-label">URL <span class="text-danger">*</span></label>
                        <input type="text" name="url" id="url" class="form-control" placeholder="Masukkan url sosial media" value="<?= old('url') ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <a href="<?= base_url('admin/icons') ?>" class="input-group-text" data-bs-toggle="tooltip" title="Klik untuk melihat dokumentasi icon">
                                <i id="preview-icon" class="<?= old('icon', 'fas fa-question') ?>"></i>
                            </a>
                            <input type="text" name="icon" id="icon" class="form-control" placeholder="Masukkan icon class sosial media" value="<?= old('icon') ?>">
                        </div>
                        <small class="text-muted">
                            Lihat daftar icon lengkap di
                            <a href="<?= base_url('admin/icons') ?>" data-bs-toggle="tooltip" title="Klik untuk melihat dokumentasi icon">
                                Dokumentasi Icon
