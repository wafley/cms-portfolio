...
<?php $this->setVar('title', 'Tambah Kegiatan') ?>
    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <?php $placeholder = base_url('images/placeholders/poster-placeholder.png') ?>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title" class="form-control" placeholder="Masukkan judul kegiatan" value="<?= old('title') ?>">
                    </div>

                    <div>
                        <label for="description" class="form-label">Deskripsi (Opsional)</label>
                        <textarea class="form-control" id="description" name="description" rows="4" placeholder="Masukan deskripsi kegiatan"><?= old('description') ?></textarea>
                    </div>
                </div>
